...
async def start(_, msg):
    ...
    await msg.reply_photo(
        photo="https://telegra.ph/file/ae84cf6362cc35fe7abbd.png",
        caption=start_txt,
...
FORBIDDEN_KEYWORDS = ["porn", "xxx", "sex", "NCERT", "XII", "page", "Ans", "meiotic", "divisions", "System.in", "Scanner", "void", "nextInt", "chemistry", "biology", "physics", "allen", "amazone", "mass", "value", "question"]
